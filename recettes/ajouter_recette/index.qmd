...
function activateQuickCommentForm(form) {
  ...
  card.innerHTML = `
    <div class="card-body">
      ...
      <form id="quick-comment-form" class="needs-validation" novalidate>
        <div class="mb-3">
          <label for="quick-comment-text" class="form-label required-field">Commentaire</label>
          <textarea id="quick-comment-text" class="form-control" rows="4" required></textarea>
          <div class="invalid-feedback">Le commentaire est requis.</div>
        </div>
  ...
  if (dateInput) dateInput.value = new Date().toISOString().slice(0, 10).replace(/-/g, "/");
  ...
  quickForm?.addEventListener("submit", (e) => {
    ...
    if (!commentaire) {
      showError("Le commentaire est requis.");
      return;
    }
