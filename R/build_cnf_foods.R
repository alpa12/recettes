...
if (length(out_rows) == 0) {
  stop("Aucune ligne CNF générée. Vérifie le mapping et les fichiers CNF.", call. = FALSE)
}
...
if (n_missing_food > 0) cat(sprintf("Mapped foods missing in FOOD NAME.csv: %d\n", n_missing_food))
